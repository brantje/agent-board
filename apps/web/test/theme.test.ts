...
describe('theme CSS architecture', () => {
  it('owns shared, dark and light token files and maps them into application CSS', () => {
    ...
    expect(dark).toContain('--board-column-review: #1f2924')
    expect(dark).toContain('--board-column-done: #202631')
    expect(dark).toContain('--activity-stream-bg:')
    expect(dark).toContain('--activity-stream-border:')
    expect(dark).toContain('--activity-todo-bg:')
    ...
    expect(light).toContain('--activity-stream-bg:')
    expect(light).toContain('--activity-stream-border:')
    expect(light).toContain('--activity-todo-bg:')
    expect(light).not.toContain(':root,')

    expect(main).toContain('.run-activity-stream')
    expect(main).toContain('var(--activity-stream-bg)')
    expect(main).toContain('var(--activity-stream-border)')
    expect(main).toContain('.run-activity-todo-list')
    expect(main).toContain('var(--activity-todo-bg)')
