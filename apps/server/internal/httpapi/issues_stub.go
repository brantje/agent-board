...
func (a *api) registerIssueRunRoutes(r chi.Router) {
	...
	r.Get("/projects/{projectID}/issues/{issueID}/subscription", a.getIssueSubscription)
	r.Put("/projects/{projectID}/issues/{issueID}/subscription", a.setIssueSubscription)
	r.Delete("/projects/{projectID}/issues/{issueID}/subscription", a.setIssueSubscription)
	...
	r.Patch("/projects/{projectID}/issues/{issueID}/comments/{commentID}", a.updateIssueComment)
	r.Delete("/projects/{projectID}/issues/{issueID}/comments/{commentID}", a.deleteIssueComment)
	r.Put("/projects/{projectID}/issues/{issueID}/comments/{commentID}/resolution", a.resolveIssueComment)
	r.Delete("/projects/{projectID}/issues/{issueID}/comments/{commentID}/resolution", a.reopenIssueComment)
	r.Put("/projects/{projectID}/issues/{issueID}/comments/{commentID}/reactions/{reaction}", a.addIssueCommentReaction)
	r.Delete("/projects/{projectID}/issues/{issueID}/comments/{commentID}/reactions/{reaction}", a.removeIssueCommentReaction)
	r.Get("/projects/{projectID}/issues/{issueID}/timeline", a.listIssueTimeline)
