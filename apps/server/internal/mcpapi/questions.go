...
func (s *Server) registerQuestionTools(server *mcp.Server) {
	mcp.AddTool(server, readOnlyTool("list_questions", "List blocking or historical Questions with optional public Issue key, Run, and status filters."), s.listQuestions)
