...
func TestGetWorkspaceIsProjectScoped(t *testing.T) {
	s := New(testPool(t))
	ctx := context.Background()
	fixture := seedRunFixture(t, s, "workspace-lookup")
	other := seedRunFixture(t, s, "workspace-lookup-other")
...
func TestWorkspaceCurrentRevisionPersistsAndIsProjectScoped(t *testing.T) {
	s := New(testPool(t))
	ctx := context.Background()
	fixture := seedRunFixture(t, s, "workspace-revision")
	other := seedRunFixture(t, s, "workspace-revision-other")
