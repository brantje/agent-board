...
The official `apps/agent-runner/Dockerfile` installs a pinned OpenCode `1.18.29` binary. Engine adapters still depend only on Agent Board Engine capabilities, not on Docker or WebSocket implementation details.
